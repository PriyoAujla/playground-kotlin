...
data class ColumnValue(val column: Column, val valueAsSqlString: ValueAsSqlString, val setter: (Int, PreparedStatement) -> PreparedStatement)
...
interface Column {
    ...
    fun toColumnValue(valueAsSqlString: ValueAsSqlString, setter: (Int, PreparedStatement) -> PreparedStatement): ColumnValue = ColumnValue(this, valueAsSqlString, setter)
}
...
data class StringColumn(override val name: ColumnName, override val required: Boolean) : TypeColumn<String> {
    ...
    override fun withValue(value: String) = toColumnValue(toSqlString(value)) { index, it ->
        it.apply {
...
data class IntColumn(override val name: ColumnName, override val required: Boolean) : TypeColumn<Int> {
    ...
    override fun withValue(value: Int) = toColumnValue(toSqlString(value)) { index, it ->
        it.apply {
            setInt(index, value)
        }
    }
...
abstract class Table<in T>(private val dataSource: DataSource) {
...
fun main(args: Array<String>) {
    ...
    val userTable = UserTable("user", dataSource)
